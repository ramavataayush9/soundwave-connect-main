  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-gold to-gold-light text-primary-foreground font-bold hover:shadow-[0_0_30px_hsl(38_92%_50%/0.5)] hover:scale-105",
        whatsapp: "bg-[#25D366] text-white hover:bg-[#20BD5A] hover:shadow-[0_0_20px_rgba(37,211,102,0.4)]",
        call: "bg-gradient-to-r from-ember to-ember-glow text-white hover:shadow-[0_0_20px_hsl(25_95%_53%/0.4)] hover:scale-105",
      },
      size: {
